...
public class Data {
	 ...
	 * @return
	 */
	public static List<NameValuePair> ThreeUserLogin(Context context,String LoginId,String PhotoUrl,String UserName){
		List<NameValuePair> list = new ArrayList<NameValuePair>();
		list.add(new BasicNameValuePair("LoginId",LoginId));
		list.add(new BasicNameValuePair("PhotoUrl",PhotoUrl));
	...
	public static List<NameValuePair> getEfficacyList(String pageNo, String countOfPage) {
		List<NameValuePair> list = new ArrayList<NameValuePair>();
		list.add(new BasicNameValuePair("PageNo", pageNo));
		list.add(new BasicNameValuePair("CountOfPage", countOfPage));
		return list;
	}
	public static List<NameValuePair> getEfficacyDetail(String efficacyId) {
		List<NameValuePair> list = new ArrayList<NameValuePair>();
		list.add(new BasicNameValuePair("EfficiencyId", efficacyId));
		return list;
	}
}
