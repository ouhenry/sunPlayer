...
import com.exmart.qiyishow.loader.core.LoadVideoTask;
...
public class TemplateDetailActivity extends Activity implements
	...
	protected void onDestroy() {
		...
		LoadVideoTask task = VideoLoader.getInstance().getTasks().get(mTemplateVideo.getUrl());
		if (task != null) {
			task.setSyncLoading(false);
		}
		super.onDestroy();
	}
